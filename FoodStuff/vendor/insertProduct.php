...
if(isset($_POST['send'])){    /*when vendor will press submit button by filling the form records then the all data  will be stored in DB */
    ...
    $query = mysqli_query($conn, "INSERT INTO product (p_name,p_brand,p_price,each_qty,p_mfg,p_img,cat_title,p_desc,Qty,v_email) value ('$p_name','$p_brand','$p_price','$each_qty','$p_mfg','$p_img','$p_cat_title','$p_desc','$qty','$log')");
