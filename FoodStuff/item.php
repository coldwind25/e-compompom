...
<body style="background:#f5f7fa">
 ...
 <div class="container-fluid" style="margin-top:100px">
  ...
  <div class="list-group shadow" style="padding:0px">
            <a href="sweets.php" class="list-group-item list-group-item-action active">ประเภทสินค้า</a>
    ...
    <div class="col-lg-10 col-12 ">
          <div class="row">
           ...
           <?php
              if(isset($_GET['p_id'])):
              $p_id = $_GET['p_id'];
              $calling = mysqli_query($conn, "SELECT * from product where p_id='$p_id'");
          ...
          <!--  <div class="col-lg-4">
            ...
            <div class=" col-lg-4 img-zoom-container">
              ...
              <a href="order.php?p_id=<?= $row['p_id']?>" class="btn btn-success py-2 " style="height:45px;width:100%;position:absolute;top:400px;left:0%">สั่งชื้อ</a>
            </div>
            ...
            <div class="col-lg-8">
              ...
              <div class="card mt-5 border border-dark">
                 <div class="card-header bg-dark text-white">รายละเอียด</div>
